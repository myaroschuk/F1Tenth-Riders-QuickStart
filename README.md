...
From the root directory, build your submission:
...
Requirements for running the submission script: [jq](https://stedolan.github.io/jq/)
...
Once it's finished, check the competition page to see how you did! (it may take a few minutes to process your new submission)
